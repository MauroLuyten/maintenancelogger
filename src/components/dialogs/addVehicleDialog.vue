      ...
      showSuggestedImages() {
        if (this.newVehicle.model) {
          ...
          Axios.get(`https://www.googleapis.com/customsearch/v1?q=`+
            `${this.newVehicle.make}${this.newVehicle.model}`+
            `&imgDominantColor=white&cx=000944192720465307300:qbm11spsnzw`+
            `&searchType=image&key=AIzaSyBv9rRn3Zbjn0wYbdM6M6PXgrvnfHwvrm0&num=3&fields=items/link`)
            .then(response => {
